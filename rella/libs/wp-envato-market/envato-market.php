 ...
 * Include the Envato Market Plugin.
 *
 * @see http://envato.github.io/wp-envato-market/
 *
 */
...
if ( ! class_exists( 'Envato_Market' ) ) :
	...
	final class Envato_Market {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'boo' ), '1.0.0' );
		}
		...
		private function init_globals() {
			...
			$this->plugin_url  = get_template_directory_uri() . '/rella/libs/wp-envato-market/';
			$this->plugin_path = get_template_directory() . '/rella/libs/wp-envato-market/';
