 ...
 */
$el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $video_bg = $video_bg_url = $video_bg_parallax = $css_animation = $gradient_bg = $gradient_bg_color = $bg_position = $bg_pos_h = $bg_pos_v = $svg_separator = $svg_color = '';
$disable_element = '';
