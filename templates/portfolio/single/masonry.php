<!-- <div class="portfolio-details details-fullwidth" data-appear-animation="true" data-appear-element="> .container > .row > [class*=col] > *,> .container-fluid > .row > [class*=col] > *" data-appear-from='{ "y": 70 }' data-appear-to='{ "y": 0, "opacity": 1, "visibility": "visible", "ease": "Power4.easeOut" }' data-stagger="true" data-appear-time="1" data-appear-delay="0.15"> -->
<div class="portfolio-details details-fullwidth">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-4" style="padding-left: 6%; padding-right: 2.5%;">
