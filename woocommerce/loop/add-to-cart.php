...
$icon_class = 'icon-ecommerce-cart-content';
...
echo apply_filters( 'woocommerce_loop_add_to_cart_link',
	sprintf( '<a rel="nofollow" data-tooltip-text="%s" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s">%s</a>',
		...
		'<i class="' . sanitize_html_class( $icon_class ) . '"></i>'
	),
$product );
