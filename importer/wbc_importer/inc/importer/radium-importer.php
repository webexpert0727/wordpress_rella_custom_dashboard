...
if ( !class_exists( 'Radium_Theme_Importer' ) ) {
  ...
  class Radium_Theme_Importer {
    ...
    public function __construct($processor) {
      ...
      $this->process_imports($processor->import_media);
    ...
    public function process_imports( $import_media ) {

      if ( !empty( $this->content_demo ) && is_file( $this->content_demo ) ) {
        $this->set_demo_data( $this->content_demo, $import_media );
      }
    ...
    public function set_demo_data( $file, $import_media ) {
      ...
      if ( $importer_error ) {
        ...
        if ( !is_file( $file ) ) {
		 ...
		 if( $import_media == true ) {$wp_import->fetch_attachments = true;}
		 else{$wp_import->fetch_attachments = false;}
